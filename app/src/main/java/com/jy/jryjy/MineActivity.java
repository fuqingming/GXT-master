...
import com.jy.jryjy.bean.response.ResponseChangeHeadBean;
import com.jy.jryjy.huanxin.DemoHelper;
import com.jgcj.library.util.Upload;
...
//        Glide.with(MineActivity.this).load( SPUtils.getInstance(GlobalVariables.serverSp).getString(GlobalVariables.serverUserIcon)).placeholder(R.mipmap.head_s).into(m_ivIcon);
    }
        ...
        RxGalleryFinal
                ...
                .subscribe(new RxBusResultDisposable<ImageRadioResultEvent>() {
                    ...
                    protected void onEvent(ImageRadioResultEvent imageRadioResultEvent) throws Exception {
                        kProgressHUD.show();
                        String strUrl = "http://gxt.mqcll.cn/index/User/changePhoto&u_id="+ SPUtils.getInstance(GlobalVariables.serverSp).getString(GlobalVariables.serverUserId);
