 ...
 *
 */
public class MyGridViewPapgerAdpter extends BaseAdapter{

    private Context context;
    private List<ProdctSeletBean> lists;//数据源
    private int mIndex; // 页数下标，标示第几页，从0开始
    private int mPargerSize;// 每页显示的最大的数量



    public MyGridViewPapgerAdpter(Context context, List<ProdctSeletBean> lists,
    ...
    @Override
    public ProdctSeletBean getItem(int arg0) {
        // TODO Auto-generated method stub
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = View.inflate(context, R.layout.item_gridview_selet_info, null);
