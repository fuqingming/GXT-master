...
public class MyGridViewAdpter extends BaseAdapter{
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null){
            ...
            convertView = View.inflate(context, R.layout.item_gridview_info, null);
        ...
        holder.tvName1.setText(lists.get(pos).getName1());
        holder.tvName2.setText(lists.get(pos).getName2());
        holder.tvName3.setText(lists.get(pos).getName3());
        //添加item监听
