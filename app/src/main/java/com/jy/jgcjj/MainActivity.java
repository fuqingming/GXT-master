...
import com.jy.jgcjj.base.FragmentActivityBase;
...
public class MainActivity extends FragmentActivityBase {
    ...
    private Class<?> m_fragmentArray[] = { FragmentHall.class,
            FragmentLive.class,FragmentLiveVideo.class,FragmentHall.class,FragmentMine.class,};
    ...
    protected void setUpView() {
        SPUtils.getInstance(GlobalVariables.serverSp).put(GlobalVariables.INTENT_NEWS_SIGN, GlobalVariables.NEWS_TEACHER_ANALYSIS);
