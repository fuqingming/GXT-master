...
public class ClassActivity extends BasePopListActivity<TeacherDetailsBean> {
    ...
    protected BaseAdapter setInitAdapter() {
        return new VideoTypeCheckedAdapter(this,DataUtil.initVideoPlayBackBean());
    }
    ...
    private void initBanner() {
        ...
        m_bpBanner.setPagerOptions(pagerOptions).setPages(m_arrBanner, new ViewHolderCreator<BannerPagerHolder>() {
            ...
            public BannerPagerHolder createViewHolder() {
                final View view = LayoutInflater.from(ClassActivity.this).inflate(R.layout.item_image_banner_hall, null);
